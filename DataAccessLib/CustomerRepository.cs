...
namespace DataAccessLib
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public CustomerRepository(FlagpoleCRMContext flagpoleCRM, ILog log)
        {
        ...
        {
            return _flagpoleCRM.AudienceCustomers.FirstOrDefault(x => x.AudienceId == audienceId && x.CustomerId == customerId);
        }
